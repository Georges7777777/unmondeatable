...
const FOOD_GROUPS = {
  ...
  alcohol: ['akvavit', 'amber_rum', 'apple_cider', 'armagnac', 'barolo_wine', 'beer', 'brandy', 'cachaca', 'calvados', 'dark_rum', 'dry_cider', 'irish_whiskey', 'kirsch', 'madeira_wine', 'marsala', 'mirin', 'ouzo', 'pastis', 'pisco', 'port_wine', 'prosecco', 'red_wine', 'rice_wine', 'rum', 'sake', 'shaoxing_wine', 'sherry', 'sparkling_wine', 'stout', 'vodka', 'whisky', 'white_rum', 'white_wine']
};
