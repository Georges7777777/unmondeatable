...
const FOOD_GROUPS = {
  ...
  rabbit: ['rabbit'],
  fish: ['anchovies', 'anchovy_fillets', 'bonito', 'bonito_flakes', 'canned_salmon', 'canned_tuna', 'carp', 'catfish', 'caviar', 'cod', 'cod_fillet', 'crawfish_tails', 'crocodile', 'cured_salmon', 'dogfish', 'dried_fish', 'dried_herring', 'eel', 'fish_cake', 'fish_head', 'flying_fish', 'freshwater_fish', 'greenland_shark', 'grouper', 'haddock_fillets', 'hilsa_fish', 'kingfish', 'lamprey', 'mackerel', 'monkfish', 'pickled_herring', 'pike', 'pollock_roe', 'pufferfish', 'red_snapper', 'rockfish', 'salmon', 'salmon_roe', 'salt_cod', 'salted_anchovies', 'salted_fish', 'salted_herring', 'salted_jellyfish', 'sardines', 'scabbard_fish', 'sea_bass', 'sea_bream', 'small_fish', 'smoked_dried_tuna', 'smoked_fish', 'smoked_haddock', 'smoked_trout', 'stockfish', 'tilapia', 'trout', 'tuna', 'white_fish', 'whitefish', 'whiting', 'whole_fish'],
  seafood: ['baby_octopus', 'baby_squid', 'barnacles', 'clams', 'cockles', 'coconut_crab', 'conch', 'crab', 'crab_claws', 'crab_meat', 'crayfish', 'crayfish_powder', 'cuttlefish', 'dried_abalone', 'dried_scallops', 'dried_shrimp', 'dungeness_crab', 'giant_clam', 'king_crab_legs', 'land_crab', 'langoustines', 'limpets', 'lobster', 'mussels', 'octopus', 'oysters', 'razor_clams', 'river_prawns', 'salted_shrimp', 'scallops', 'sea_urchin', 'shrimp', 'small_shrimp', 'smoked_shrimp', 'snails', 'spot_prawns', 'squid', 'squid_ink', 'wedge_clams'],
